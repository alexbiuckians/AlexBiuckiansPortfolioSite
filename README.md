...
A single-page site built from scratch with plain HTML, CSS and vanilla JavaScript — no framework, no build step. Project content lives in two data arrays near the bottom of `index.html`, so adding a project doesn't require touching the page markup. Deployed on GitHub Pages.
...
**Languages & Analytics:** Python, R, SQL, SAS, C++, JavaScript
 
**ML & Statistics:** pandas, NumPy, SciPy, scikit-learn, LightGBM, XGBoost, PyTorch, tidymodels, SHAP, DALEX, causalml, econml, statsmodels, Optuna, SMOTE, LangChain, ChromaDB
...
**M.S. in Data Science** — George Washington University, Expected May 2027
 
**B.A. in Sport Management,** Minor in Data Analytics & Statistics — High Point University, December 2024
 
## 📄 Need the full breakdown?
 
[Download My Resume](https://alexbiuckians.github.io/AlexBiuckiansPortfolioSite/Alex_Biuckians_Resume.pdf)
 
## 🛠 Built with
 
HTML · CSS · vanilla JavaScript · no framework, no build step · deployed on GitHub Pages
